...
let form = useForm({
       ...
       'reason': '',
       'service_id': '',
       'name': props.isStandard ? props.users.name : '',

})

 const nameValue = computed(() => {
    return props.isStandard && props.users ? props.users.name : '';
  });
  ...
  onMounted(() => {
    ...
    // Assign the value to form.name
    form.name = nameValue.value;
  });
    const isAdmin = props.isAdmin;
      const isStandard = props.isStandard;
