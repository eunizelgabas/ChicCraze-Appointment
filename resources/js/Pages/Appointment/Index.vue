                                        ...
                                        <div class="flex item-center justify-center">
                                            <div class="flex item-center justify-center" v-if="app.status == 'Pending'">
                                                ...
                                                <div class="w-4 mr-5 transform hover:text-green-500 hover:scale-110">
                                                    ...
                                                    <Link :href="'/appointment/accept/' + app.id" method="post" class="btn " title="Accept Appointment">
                                                ...
                                                <div class="w-4 mr-2 transform hover:text-red-500 hover:scale-110">
                                                    ...
                                                    <Link :href="'/appointment/cancel/' + app.id" method="post" class="btn " title="Cancel Appointment">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
